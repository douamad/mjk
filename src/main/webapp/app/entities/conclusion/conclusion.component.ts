...
export class ConclusionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.conclusionService
      ...
      .subscribe(
        (res: HttpResponse<IConclusion[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IConclusion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

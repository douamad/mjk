...
import { AssistanceComponent } from 'app/entities/assistance/assistance.component';
...
describe('Component Tests', () => {
  describe('Assistance Management Component', () => {
    let comp: AssistanceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AssistanceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.assistances && comp.assistances[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

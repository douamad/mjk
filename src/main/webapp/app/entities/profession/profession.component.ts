...
export class ProfessionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.professionService
      ...
      .subscribe(
        (res: HttpResponse<IProfession[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProfessions(): void {
    this.eventSubscriber = this.eventManager.subscribe('professionListModification', () => this.loadPage());
  }
